<section class="relative w-full h-[90vh] overflow-hidden group">
    ...
    <img src="{{ asset('./img/banner1.jpg') }}" 
         ...
         class="absolute inset-0 w-full h-full object-cover transform scale-105 transition-transform duration-[6000ms] ease-out group-hover:scale-100">
   ...
   class="mt-6 inline-flex w-100 items-center justify-center 
          ...
          shadow-md shadow-indigo-900/30 text-white font-semibold text-sm 
