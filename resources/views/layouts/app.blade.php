...
<body class="font-sans bg-light-bg antialiased @yield('body-class')">
    ...
    const htmlElement = document.documentElement; // O document.body
    ...
    // Para simular el "collapse" de Bootstrap, necesitarías un botón de hamburguesa y JS para
    // alternar la visibilidad de #navbarNav en pantallas pequeñas.
    // Ejemplo (añadirías un botón en el HTML de la barra de navegación principal):
    // <button id="navbarToggle" class="md:hidden">...</button>
